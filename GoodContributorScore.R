...
names(data_str_tr)[length(names(data_str_tr))] <- "EditOwnAnswer"
data_str_tr$EditOwnAnswer <- ifelse(is.na(data_str_tr$EditOwnAnswer), 0, 1)
rm(PostHistory)
...
data_str_tr$CorrectGrammarScore <- 100 - round((data_str_tr$grammarErrors/
                                            data_str_tr$WordsCount)*100, 2)
rm(grammar_spelling_analysis, html2txt)
